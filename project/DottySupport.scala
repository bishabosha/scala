 ...
 */
object DottySupport {
  val currentDottyRelease = "0.20.0-RC1"
  val dottyLibrary = "ch.epfl.lamp" % "dotty-library_0.20" % currentDottyRelease
  val dottyCompiler = "ch.epfl.lamp" % "dotty-compiler_0.20" % currentDottyRelease
